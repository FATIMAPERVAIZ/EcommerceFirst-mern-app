...
const ProductDetails = () => {
  ...
  const getProduct = async () => {
    ...
    const addToCart = () => {
      ...
      localStorage.setItem("cart", JSON.stringify([...cart, product])); // Save cart to localStorage
    ...
    <Layout>
      <div className="row container product-details">
        ...
        <div className="col-md-6 product-details-info">
          ...
          <button class="btn btn-secondary ms-1" onClick={addToCart}>ADD TO CART</button>
        </div>
      </div>
      <hr />
